...
def MW(all_students,map1, client, epsilon):
    ...
    ##first iteration: find the nearest neighbor from h
    mindis1 = inf
    ...
    usededges.append((v1,h))
    usededges.append((h,v1))
    ...
    while remainbots > 0:
        ...
        if un == 0: #very rare case, you may omit
            ...
            visited.add(un)
            unvisited.remove(un)
            usededges.append((un,vn))
            usededges.append((vn,un))
